...
/**
 * Servlet implementation class Admingetpassword
 */
@WebServlet("/Admingetpassword")
public class Admingetpassword extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Admingetpassword() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Administrator acct=new Administrator();
		String psw="1";
		
		acct.setName(username);
		acct.setEmail(email);
		if(userService.isAGetPasswordOK(acct)){
			psw=userService.getAdministrator(acct).getPassword();
