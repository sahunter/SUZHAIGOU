		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="active"><a href="charts.jsp"><i
						class="fa fa-signal"></i> <span>图表 &amp; 图</span></a></li>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				<a href="#" title="Go to Home" class="tip-bottom"><i
					class="fa fa-home"></i>主页</a> <a href="#" class="current">图表 &amp;
					图</a>
			</div>
					...
					<div class="widget-box widget-plain">
						<div class="widget-content center">
							<ul class="stats-plain">
								<li>
									<h4>36094</h4> <span>总访问量</span>
								</li>
								<li>
									<h4>1433</h4> <span>用户注册</span>
								</li>
								<li>
									<h4>8650</h4> <span>完成的订单</span>
								</li>
								<li>
									<h4>29</h4> <span>等待订单</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="col-xs-12">
					<div class="widget-box">
						<div class="widget-title">
							<span class="icon"> <i class="fa fa-bar-chart-o"></i>
							</span>
							<h5>Line chart</h5>
						</div>
						...
						<div class="widget-content nopadding">
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										<td><a href="#">jQuery UI提示</a></td>
										<td>5377</td>
									</tr>
									<tr>
										<td><a href="#">100 +免费图标集</a></td>
										<td>4990</td>
									</tr>
									<tr>
										<td><a href="#">如何使用Google Web工具</a></td>
										<td>4834</td>
									</tr>
								</tbody>
							</table>
