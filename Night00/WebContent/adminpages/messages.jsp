	...
	<div id="wrapper">
		...
		<div id="user-nav">
			<ul class="btn-group">
				<li class="btn"><a title="" href="#"><i class="fa fa-user"></i>
						<span class="text">配置文件</span></a></li>
				<li class="btn dropdown" id="menu-messages"><a href="#"
					...
					class="dropdown-toggle"><i class="fa fa-envelope"></i> <span
						class="text">消息</span> <span class="label label-danger">5</span> <b
						class="caret"></b></a>
					<ul class="dropdown-menu messages-menu">
						<li class="title"><i class="fa fa-envelope-alt"></i>消息<a
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li><a href="charts.jsp"><i class="fa fa-signal"></i> <span>图标
							&amp;图</span></a></li>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				<a href="#" title="Go to Home" class="tip-bottom"><i
					class="fa fa-home"></i>主页</a> <a href="#" class="current">小部件</a>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-lg-6">
					<div class="widget-box">
						<div class="widget-title">
							<span class="icon"> <i class="fa fa-file"></i>
							</span>
							<h5>最近的帖子</h5>
						</div>
					...
					<div class="widget-box collapsible">
						<div class="widget-title">
							<a href="#collapseOne" data-toggle="collapse"> <span
								class="icon"><i class="fa fa-arrow-right"></i></span>
					...
					<div class="widget-box collapsible">
						<div class="widget-title">
							<a href="#collapseTwo" data-toggle="collapse"> <span
								class="icon"><i class="fa fa-times"></i></span>
						...
						<div class="widget-content nopadding updates">
							<div class="new-update clearfix">
								...
								<div class="update-done">
									<a title="" href="#"><strong>A new server is on
											the board!</strong></a> <span>We've just set up a new server. Our
										gurus ...</span>
								</div>
								<div class="update-date">
									<span class="update-day">08</span>feb
								</div>
							...
							<div class="new-update clearfix">
								<i class="fa fa-exclamation-circle"></i> <span
									class="update-alert"> <a title="" href="#"><strong>[
											URGENT ] ex.ua was closed by government</strong></a> <span>But
										already everything was solved. It will ...</span>
								</span> <span class="update-date"><span class="update-day">08</span>feb</span>
							</div>

							<div class="new-update clearfix">
								<i class="fa fa-check-circle"></i> <span class="update-done">
									<a title="" href="#"><strong>The goal was reached!</strong></a>
									<span>We just passed 1000 sales! Congrats to all</span>
								</span> <span class="update-date"><span class="update-day">07</span>feb</span>
							</div>

							<div class="new-update clearfix">
								<i class="fa fa-question-circle"></i> <span
									class="update-notice"> <a title="" href="#"><strong>Meat
											a new team member - Don Corleone</strong></a> <span>Very dyplomatic
										and flexible sales manager</span>
								</span> <span class="update-date"><span class="update-day">06</span>feb</span>
							</div>
				...
				<div class="col-xs-12 col-sm-6 col-lg-6">
							...
							<ul class="recent-comments">
								<li>
									...
									<div class="comments">
										...
										<a href="#" class="btn btn-primary btn-xs">Edit</a> <a
											href="#" class="btn btn-success btn-xs">Approve</a> <a
											href="#" class="btn btn-warning btn-xs">Mark as spam</a> <a
											href="#" class="btn btn-danger btn-xs">Delete</a>
									</div>
								</li>
								<li>
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<table class="table table-striped table-bordered">
								...
								<tbody>
									<tr>
										<td class="taskDesc"><i class="fa fa-info-circle"></i>
											Code a new theme</td>
										<td class="taskStatus"><span class="in-progress">in
												progress</span></td>
										<td class="taskOptions"><a href="#" class="tip-top"
											data-original-title="Update"><i class="fa fa-check"></i></a>
											<a href="" class="tip-top" data-original-title="Delete"><i
												class="fa fa-times"></i></a></td>
									</tr>
									<tr>
										<td class="taskDesc"><i class="fa fa-plus-circle"></i>
											Update a site</td>
									...
									<tr>
										<td class="taskDesc"><i class="fa fa-check-circle"></i>
											Meet the customers</td>
					...
					<div class="widget-box">
						...
						<div class="widget-content tab-content">
							...
							<div id="tab2r" class="tab-pane active ">This is a Tab Two
								Content</div>
						</div>
					</div>
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<ul class="activity-list">
								<li><a href="#"> <i class="fa fa-user"></i> <strong>Admin</strong>
										added <strong>1 user</strong> <span>2 hours ago</span>
								</a></li>
								<li><a href="#"> <i class="fa fa-file"></i> <strong>Caroline
											Trin</strong> write a <strong>blog post</strong> <span>Yesterday</span>
								</a></li>
								<li><a href="#"> <i class="fa fa-envelope"></i> <strong>John
											Doe</strong> sent a <strong>message</strong> <span>2 days ago</span>
								</a></li>
								<li><a href="#"> <i class="fa fa-picture-o"></i> <strong>Matt
									...
									<div class="tabbable inline">
										<ul class="nav nav-tabs tab-bricky" id="myTab">
											<li class="active"><a data-toggle="tab"
												href="#panel_tab2_example1"> Tab 1 </a></li>
											<li><a data-toggle="tab" href="#panel_tab2_example2">
													Tab 2 </a></li>
											<li class="dropdown"><a data-toggle="dropdown"
												class="dropdown-toggle" href="#"> Dropdown &nbsp; <i
													class="fa fa-caret-down width-auto"></i>
											</a>
												<ul class="dropdown-menu dropdown-info">
													<li><a data-toggle="tab" href="#panel_tab2_example3">
															Dropdown 1 </a></li>
													<li><a data-toggle="tab" href="#panel_tab2_example4">
															Dropdown 2 </a></li>
												</ul></li>
										</ul>
										<div class="tab-content">
											...
											<div id="panel_tab2_example2" class="tab-pane">
												<p>Lorem ipsum dolor sit amet, consetetur sadipscing
													...
													vero eos et accusam et justo.</p>
											</div>
											<div id="panel_tab2_example3" class="tab-pane">
												<p>Etsy mixtape wayfarers, ethical wes anderson tofu
													...
													pack lo-fi farm-to-table readymade.</p>
												<p>Raw denim you probably haven't heard of them jean
													shorts Austin. Nesciunt tofu stumptown aliqua, retro synth
								...
								<div class="col-sm-6">
									<div class="tabbable inline tabs-below">
										<div class="tab-content">
											<div id="panel_tab5_example1" class="tab-pane active">
												<p>Raw denim you probably haven't heard of them jean
													...
													vegan helvetica. Reprehenderit butcher retro keffiyeh
													dreamcatcher synth.</p>
												<p>Cosby sweater eu banh mi, qui irure terry richardson
										...
										<ul class="nav nav-tabs tab-purple" id="myTab2">
											<li class="active"><a data-toggle="tab"
												href="#panel_tab5_example1"> Tab 1 </a></li>
											<li class=""><a data-toggle="tab"
												href="#panel_tab5_example2"> Tab 2 </a></li>
											<li class=""><a data-toggle="tab"
												href="#panel_tab5_example3"> Tab 3 </a></li>
										</ul>
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="tabbable inline tabs-left">
										<ul class="nav nav-tabs tab-green" id="myTab3">
											<li class="active"><a data-toggle="tab"
												href="#panel_tab4_example1"> Tab 1 </a></li>
											<li class=""><a data-toggle="tab"
												href="#panel_tab4_example2"> Tab 2 </a></li>
											<li class=""><a data-toggle="tab"
												href="#panel_tab4_example3"> Tab 3 </a></li>
										</ul>
										<div class="tab-content">
								...
								<div class="col-sm-6">
									<div class="tabbable inline tabs-right">
										<ul class="nav nav-tabs tab-padding tab-space-3 tab-blue"
											id="myTab4">
											<li class="active"><a data-toggle="tab"
												href="#panel_tab3_example1"> Tab 1 </a></li>
											<li><a data-toggle="tab" href="#panel_tab3_example2">
													Tab 2 </a></li>
											<li><a data-toggle="tab" href="#panel_tab3_example3">
													Tab 3 </a></li>
										</ul>
										<div class="tab-content">
