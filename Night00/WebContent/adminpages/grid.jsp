	...
	<div id="wrapper">
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="active"><a href="grid.jsp"><i
						class="fa fa-th-list"></i> <span>网格布局</span></a></li>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				<a href="#" title="Go to Home" class="tip-bottom"><i
					class="fa fa-home"></i> 主页</a> <a href="#" class="current">网格布局</a>
			</div>
				...
				<div class="col-xs-12">
					<div class="widget-box">
						<div class="widget-title">
							<span class="icon"> <i class="fa fa-th-list"></i>
							</span>
							<h5>Span12</h5>
						</div>
