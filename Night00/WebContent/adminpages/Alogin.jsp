...
<body>
	<div id="container">
		...
		<div id="user">
			...
			<div class="text">
				<h4>
					Hello,<span class="user_name"></span>
				</h4>
			</div>
		</div>
		<div id="loginbox">
			<form id="loginform" method="post" action="../adminlogin.do">
				<p>输入用户名和密码继续。</p>
			...
			<form id="recoverform" method="post" action="Admingetpassword">
				<p>下面输入您的电子邮件地址,我们将给你发送指令如何恢复密码。</p>
				<div class="input-group">
				...
				<div class="form-actions clearfix">
					<div class="pull-left">
						<a href="#loginform" class="grey flip-link to-login">点击登录</a>
					</div>
					<div class="pull-right">
						<a href="#registerform" class="blue flip-link to-register"></a>
					</div>
