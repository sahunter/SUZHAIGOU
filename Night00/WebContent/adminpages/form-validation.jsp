...
<body data-color="grey" class="flat">
	<div id="wrapper">
			...
			<ul>
				...
				<li class="submenu active open"><a href="#"><i
					...
					<ul>
						...
						<li class="active"><a href="form-validation.jsp">验证</a></li>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				<a href="Aindex.jsp" title="Go to Home" class="tip-bottom"><i
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                                    <div class="form-group">
                                        <label class="col-sm-3 col-md-3 col-lg-2 control-label">请求域</label>
                                        <div class="col-sm-9 col-md-9 col-lg-10">
                                            <input type="text" class="form-control input-sm" name="required" id="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-md-3 col-lg-2 control-label">邮件</label>
                                        <div class="col-sm-9 col-md-9 col-lg-10">
                                            <input type="text" class="form-control input-sm" name="email" id="email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-md-3 col-lg-2 control-label">日期</label>
                                        <div class="col-sm-9 col-md-9 col-lg-10">
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="#" name="number_validate" id="number_validate" novalidate="novalidate">
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-2 control-label">最小值</label>
										<div class="col-sm-9 col-md-9 col-lg-10">
											<input type="text" class="form-control input-sm" name="min" id="min" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-2 control-label">最大值</label>
										<div class="col-sm-9 col-md-9 col-lg-10">
											<input type="text" class="form-control input-sm" name="max" id="max" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-2 control-label">唯一值</label>
										<div class="col-sm-9 col-md-9 col-lg-10">
