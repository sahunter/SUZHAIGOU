<%@ page import="ecshop.night.model.*,java.util.List" language="java"
		...
		<div id="content">
			...
			<div id="breadcrumb">
				<a href="#" title="" class="tip-bottom"><i class="fa fa-home"></i>
					主页</a> <a href="#">样本页</a> <a href="#" class="current">画廊</a>
			</div>
						...
						<div class="widget-content">
							<div class="gallery-masonry">
								<div class="item">
									<a href="#" class="thumbnail"> <%
			 						for (int i = 0; i < blahs.size(); i++) { 
			 							Goods bh = blahs.get(i);
			 						%> <img src="../<%=bh.getPicture() %>" alt=""><br> <%} %>
									</a>
									<div class="actions">
										<div class="actions-inner">
											<!-- 	<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a> -->
											<a title="删除" href="#" class="tip-top"><i
								...
								<!--  <div class="item">
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img10.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img11.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img12.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img13.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img14.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img15.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img16.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img17.jpg" alt="">
										</a>
										<div class="actions">
											<div class="actions-inner">
												<a title="Edit" href="#" class="tip-top"><i class="fa fa-pencil"></i></a>
										...
										<a href="#" class="thumbnail">
											<img src="img/demo/img18.jpg" alt="">
										</a> 
							...
							<span style="font-size: 10px; color: #888888;"> <a
								href="http://creativecommons.org/licenses/by-nd/2.0/deed.en"></a>,
								<a href="http://www.flickr.com/photos/sbl83/"></a></span>
						</div>
					</div>
