<%@ page
	import="ecshop.night.model.WebService,ecshop.night.model.Shoppingcart,java.util.List"
	...
	<div class="container">
		<div class="check">
			 ...
			 <div class="cart-header">
				 ...
				 <div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							 <img src="${blah.picture}" class="img-responsive" alt="图片"/>
						</div>
					   <div class="cart-item-info">
						<h3><a href="#"> ${blah.goodsname}</a><span>${blah.introduction}</span></h3>
						<ul class="qty">
							<li><p>单价 :￥${blah.price} </p></li>
							<li><p>数量 : ${blah.quantity}</p></li>
						</ul>
						<div class="delivery">
							 <p>卖家 : ${blah.seller}</p>
							 <span></span>
				...
				<%
			 	for (int i = 0; i < blahs.size(); i++) { 
			 		Shoppingcart bh = blahs.get(i);
			 %>
				<div class="cart-header2">
					<a
						href="deletecart.do?goodsname1=<%=bh.getGoodsName() %>&&seller1=<%=bh.getSeller() %>">
						<div class="close2 delete">

							<%--!<form action="deletecart.do?goodsname1=<%=bh.getGoodsName() %>" method="get"><input type="submit"  value="×"> </form> --%>
						</div>
					</a>
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
			...
			<%-- <div class="col-md-3 cart-total">
				<a class="continue" href="index.jsp">继续去购物</a>
