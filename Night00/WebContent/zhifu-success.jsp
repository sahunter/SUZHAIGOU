...
<body>
	...
	<div class="row">
		...
		<div class="col-xs-6" style="padding-top: 140px; padding-left: 40px;">
			<h2>${requestScope.uname}支付成功，我们将尽快给您送货</h2>
			<div class="#" style="padding-top: 40px; padding-left: 140px;">
				<a href="index.jsp">点击此处返回首页继续浏览商品 </a>
			</div>
		</div>
	</div>
