...
<body>
	...
	<c:forEach var="blah" items="${requestScope.blahs}">
		...
		<a href="single.html"> <img src='${blah.picture}' alt="图片" /></a>
		<h5>
			<a href="single.html"> ${blah.goodsname}</a>
		</h5>
		<h6>It is a long establishe ${blah.introduction}</h6>

		<span>￥${blah.price}</span>
