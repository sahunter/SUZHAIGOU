...
<html>
<head>
<title>Buy_shop an E-Commerce online Shopping Category Flat
	Bootstarp responsive Website Template| Men :: w3layouts</title>
...
<body>
		...
		<div class="container">
			<div class="col-xs-8 header-bottom-left">
				<div class="col-xs-2 logo">
					<h1>
						<a href="index.html"><span>Buy</span>shop</a>
					</h1>
				</div>
				<div class="col-xs-6 menu">
					<ul class="megamenu skyblue">
						<li><a class="color1" href="index.html">Men</a>
						<div class="megapanel">
								<div class="row">
									<div class="col1">
										<div class="h_nav">
	...
	<div class="container">
		<div class="women_main">
			<div class="col-md-9 w_content">
				...
				<div class="grids_of_4">
					<div class="grid1_of_4 simpleCart_shelfItem">
						<div class="content_box">
							<a href="single.html">
								<div class="view view-fifth">
									<img src="images/ZYJ(Q3D{CO[TGXO5K35ZKGK.png"
						...
						<h5>
							<a href="single.html"> 西柚</a>
						</h5>
						<h6>It is a long establishe</h6>
						<div class="size_1">
							<span class="item_price">￥12.5</span> <select class="item_Size">
				...
				<div class="grid1_of_4 simpleCart_shelfItem">
					<div class="content_box">
						<a href="single.html">
							<div class="view view-fifth">
								<img src="images/XTZTXOR18N8A7UAJ[BH8UCV.png"
									class="img-responsive" alt="" />
								<div class="mask1">
									<div class="info"></div>
								</div>
					...
					<h5>
						<a href="single.html"> 紫薯</a>
					</h5>
					<h6>It is a long establishe</h6>
					<div class="size_1">
						<span class="item_price">￥8.2</span> <select class="item_Size">
							<option value="Small">款式1</option>
							<option value="Medium">款式2</option>
							<option value="Large">款式3</option>
							<option value="Large">款式4</option>
			...
			<div class="grid1_of_4 simpleCart_shelfItem">
				<div class="content_box">
					<a href="single.html">
						<div class="view view-fifth">
							<img src="images/X300(5(22CBH6O`)E{VKRU3.png"
								class="img-responsive" alt="" />
							<div class="mask1">
								<div class="info"></div>
							</div>
				...
				<h5>
					<a href="single.html"> 樱桃</a>
				</h5>
				<h6>It is a long establishe</h6>
				<div class="size_1">
					<span class="item_price">￥27.5</span> <select class="item_Size">
						<option value="Small">款式1</option>
						<option value="Medium">款式2</option>
						<option value="Large">款式3</option>
						<option value="Large">款式4</option>
		...
		<div class="grid1_of_4 simpleCart_shelfItem">
			<div class="content_box">
				<a href="single.html">
					<div class="view view-fifth">
						<img src="images/WZLN{LT@4`VP~55]I]1R0ZX.png"
							class="img-responsive" alt="" />
						<div class="mask1">
							<div class="info"></div>
						</div>
			...
			<h5>
				<a href="single.html"> 菠萝</a>
			</h5>
			<h6>It is a long establishe</h6>
			<div class="size_1">
				<span class="item_price">￥12.9</span> <select class="item_Size">
					<option value="Small">款式1</option>
					<option value="Medium">款式2</option>
					<option value="Large">款式3</option>
					<option value="Large">款式4</option>
	...
	<div class="grids_of_4">
		<div class="grid1_of_4 simpleCart_shelfItem">
			<div class="content_box">
				<a href="single.html">
					<div class="view view-fifth">
						<img src="images/R2)HQLICSH(WT15V[$ADY7L.png"
							class="img-responsive" alt="" />
						<div class="mask1">
							<div class="info"></div>
						</div>
			...
			<h5>
				<a href="single.html"> 火龙果</a>
			</h5>
			<h6>It is a long establishe</h6>
			<div class="size_1">
				<span class="item_price">￥8.9</span> <select class="item_Size">
					<option value="Small">款式1</option>
					<option value="Medium">款式2</option>
					<option value="Large">款式3</option>
					<option value="Large">款式4</option>
	...
	<div class="grid1_of_4 simpleCart_shelfItem">
		<div class="content_box">
			<a href="single.html">
				<div class="view view-fifth">
					<img src="images/M843~W{46$7Q8GBFRB}2G95.png"
						class="img-responsive" alt="" />
					<div class="mask1">
						<div class="info"></div>
					</div>
		...
		<h5>
			<a href="single.html"> 牛油果</a>
		</h5>
		<h6>It is a long establishe</h6>
		<div class="size_1">
			<span class="item_price">￥15.5</span> <select class="item_Size">
				<option value="Small">款式1</option>
				<option value="Medium">款式2</option>
				<option value="Large">款式3</option>
				<option value="Large">款式4</option>
	...
	<div class="grid1_of_4 simpleCart_shelfItem">
		<div class="content_box">
			<a href="single.html">
				<div class="view view-fifth">
					<img src="images/BKOS4TONRZVNQG5OS8{2W[E.png"
						class="img-responsive" alt="" />
					<div class="mask1">
						<div class="info"></div>
					</div>
		...
		<h5>
			<a href="single.html"> 黄瓜</a>
		</h5>
		<h6>It is a long establishe</h6>
		<div class="size_1">
			<span class="item_price">￥3.5</span> <select class="item_Size">
				<option value="Small">款式1</option>
				<option value="Medium">款式2</option>
				<option value="Large">款式3</option>
				<option value="Large">款式4</option>
	...
	<div class="grid1_of_4 simpleCart_shelfItem">
		<div class="content_box">
			<a href="single.html">
				<div class="view view-fifth">
					<img src="images/8GZO_OYQMQTB]NJ6N[6EM~U.png"
						class="img-responsive" alt="" />
					<div class="mask1">
						<div class="info"></div>
					</div>
		...
		<h5>
			<a href="single.html"> 龙虾</a>
		</h5>
		<h6>It is a long establishe</h6>
		<div class="size_1">
			<span class="item_price">￥22.9</span> <select class="item_Size">
				<option value="Small">款式1</option>
				<option value="Medium">款式2</option>
				<option value="Large">款式3</option>
				<option value="Large">款式4</option>
	...
	<div class="grids_of_4">
		<div class="grid1_of_4 simpleCart_shelfItem">
			<div class="content_box">
				<a href="single.html">
					<div class="view view-fifth">
						<img src="images/4@9~AGGAWZ9BS$R3_WSDN_1.png"
							class="img-responsive" alt="" />
						<div class="mask1">
							<div class="info"></div>
						</div>
			...
			<h5>
				<a href="single.html"> 奇异果</a>
			</h5>
			<h6>It is a long establishe</h6>
			<div class="size_1">
				<span class="item_price">￥17.9</span> <select class="item_Size">
					<option value="Small">款式1</option>
					<option value="Medium">款式2</option>
					<option value="Large">款式3</option>
					<option value="Large">款式4</option>
	...
	<div class="grid1_of_4 simpleCart_shelfItem">
		<div class="content_box">
			<a href="single.html">
				<div class="view view-fifth">
					<img src="images/shipin5.png" class="img-responsive" alt="" />
					<div class="mask1">
						<div class="info"></div>
					</div>
			</a>
	...
	<div class="grid1_of_4 simpleCart_shelfItem">
		<div class="content_box">
			<a href="single.html">
				<div class="view view-fifth">
					<img src="images/0}3Q$ZQNAJ4UYEXTVCT}SWH.png"
						class="img-responsive" alt="" />
					<div class="mask1">
						<div class="info"></div>
					</div>
		...
		<h5>
			<a href="single.html"> 玉米</a>
		</h5>
		<h6>It is a long establishe</h6>
		<div class="size_1">
			<span class="item_price">￥1.5</span> <select class="item_Size">
				<option value="Small">款式1</option>
				<option value="Medium">款式2</option>
				<option value="Large">款式3</option>
				<option value="Large">款式4</option>
	...
	<div class="grid1_of_4 simpleCart_shelfItem">
		<div class="content_box">
			<a href="single.html">
				<div class="view view-fifth">
					<img src="images/shipin6.png" class="img-responsive" alt="" />
					<div class="mask1">
						<div class="info"></div>
					</div>
			</a>
		...
		<h5>
			<a href="single.html"> 苹果</a>
		</h5>
		<h6>It is a long establishe</h6>
		<div class="size_1">
			<span class="item_price">￥4.5</span> <select class="item_Size">
				<option value="Small">款式1</option>
				<option value="Medium">款式2</option>
				<option value="Large">款式3</option>
				<option value="Large">款式4</option>
	...
	<div class="footer">
		<div class="container">
				...
				<div class="col-md-4 box_3">
					...
					<address class="address">
						...
						<dl>
							...
							<dd>
								E-mail:&nbsp; <a href="mailto@example.com">info(at)buyshop.com</a>
							</dd>
						</dl>
					</address>
			...
			<div class="footer_bottom">
				<div class="copy">
					<p>
						Copyright © 2015 Buy_shop. All Rights Reserved.<a
