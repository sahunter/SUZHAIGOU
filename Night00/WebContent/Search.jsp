			...
			<div class="col-xs-8 header-bottom-left">
				...
				<div class="col-xs-6 menu">
					<ul class="megamenu skyblue">
						<li><a class="color1" href="index.html">热卖商品</a>
						<div class="megapanel">
								<div class="row">
									<div class="col1">
										<div class="h_nav">
				...
				<div class="grid1_of_4 simpleCart_shelfItem">
					<div class="content_box">
						...
						<div class="view view-fifth">
							<a
								href="single.jsp?mess1=<%=bh.getGoodsname() %>&&mess2=<%=bh.getSeller() %>">
								<%--!&&mess3=${blah.picture}&&mess4=${blah.price} --%> <img
								src="<%=bh.getPicture() %>" class="img-responsive" alt="图片" />
								<div class="mask1">
									<div class="info"></div>
								</div>
							</a>
						...
						<h6>
							买吧！
							<%=bh.getIntroduction() %></h6>
						<div class="size_1">
							<span class="item_price">￥<%=bh.getPrice() %></span> <select
								class="item_Size">
						...
						<form action="">
							...
							<div class="size_2">
								...
								<div class="size_2-right">
									<input goodsname="<%=bh.getGoodsname() %>"
										seller="<%=bh.getSeller() %>" type="button"
										class="item_add add3" value="" />
								</div>
								<div class="clearfix"></div>
							</div>
						</form>
